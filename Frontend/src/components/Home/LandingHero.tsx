...
import { Blocks, GraduationCap, Briefcase, ArrowRight } from "lucide-react";
...
const LandingHero = React.memo(() => {
  ...
  const lowerHeroRef = useRef<HTMLDivElement>(null);
  ...
  useEffect(() => {
    // Refresh ScrollTrigger when theme changes (for image swap)

...
interface ApplicationCardProps {
  ...
  onShortlist: (applicationId: string, opportunityId: string) => void;
  onReject: (applicationId: string, opportunityId: string) => void;
  onRefer: (applicationId: string, opportunityId: string) => void;
}

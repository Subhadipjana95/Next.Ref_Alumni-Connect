import { Job, Student } from '@/lib/types';
...
export function ReferralsList({ jobs, student, isApplying, onApply }: ReferralsListProps) {
  // All jobs posted by alumni are referral opportunities
  // Students can apply for referrals through these jobs

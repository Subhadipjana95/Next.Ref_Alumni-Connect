...
export function QRCodeSection({ student, address }: QRCodeSectionProps) {
  const [qrCodeData, setQrCodeData] = useState<{ qrCodeUrl: string; dataHash: string } | null>(null);
  ...
  const handleGenerateQR = async () => {
    ...
    try {
      ...
      // Create simple data hash
      const dataHash = `hash_${Date.now()}`;
      
      // For demonstration - use a placeholder QR code

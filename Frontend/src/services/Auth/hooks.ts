...
export function useAuthForm<T extends object>(initialData: T) {
...
const initialStudentSignup: StudentSignupPayload = {
  firstName: '',
  lastName: '',
  email: '',
  password: '',
...
export function useStudentSignup() {
  ...
  const handleSubmit = useCallback(async (): Promise<AuthResponse> => {
    if (!validate()) {
...
const initialAlumniSignup: AlumniSignupPayload = {
  firstName: '',
  lastName: '',
  email: '',
  password: '',
...
const initialVerifierSignup: StudentSignupPayload = {
  firstName: '',
  lastName: '',
  email: '',
  password: '',
  ...
  const handleSubmit = useCallback(async (): Promise<AuthResponse> => {
    ...
    try {
      ...
      if (response.success && response.user) {
        ...
        const verifierUser = { ...response.user, accountType: 'Verifier' as const };
...
export function useRoleBasedAuth(role: Role) {

...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const studentSignup = useCallback(async (data: StudentSignupPayload): Promise<AuthResponse> => {
  ...
  const studentLogin = useCallback(async (data: LoginPayload): Promise<AuthResponse> => {
    dispatch({ type: 'AUTH_START' });
    try {
  ...
  const alumniSignup = useCallback(async (data: AlumniSignupPayload): Promise<AuthResponse> => {
    dispatch({ type: 'AUTH_START' });
    try {
  ...
  const alumniLogin = useCallback(async (data: LoginPayload): Promise<AuthResponse> => {
    dispatch({ type: 'AUTH_START' });
    try {
